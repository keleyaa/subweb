...
| MyUrls v2 | [keleyaa/MyUrls](https://github.com/keleyaa/MyUrls)，原始项目为 [CareyWang/MyUrls](https://github.com/CareyWang/MyUrls) | stable tag `v2.0.2`；commit `c86c5d6d7d85eb1c02bfdef73dff489e8a547395`；manifest `sha256:b76423a5b5f346c27c40cbecb3954409f645f85df462d49577bb14d738d6127b` | 不在本仓库修改 |
...
已成功运行的手动发布工作流，并由上游 stable tag `v2.0.2` 标识；锁文件同时记录源码 commit
和不可变的 manifest digest。
