...
: "${TRUSTED_PROXY_CIDR:=$(read_local_env_value "$project_root/.env" TRUSTED_PROXY_CIDR 2>/dev/null || true)}"
export LOCAL_VITE_PORT LOCAL_SUBCONVERTER_PORT LOCAL_MYURLS_PORT LOCAL_REDIS_PORT LOCAL_APP_PORT LOCAL_API_PORT LOCAL_SHORT_PORT TRUSTED_PROXY_CIDR
