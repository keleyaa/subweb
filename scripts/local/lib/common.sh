...
is_local_env_key_allowed() {
  case ${1-} in
    LOCAL_VITE_PORT|LOCAL_SUBCONVERTER_PORT|LOCAL_MYURLS_PORT|LOCAL_REDIS_PORT|LOCAL_APP_PORT|LOCAL_API_PORT|MYURLS_SOURCE_DIR|SUBCONVERTER_SOURCE_DIR|BUILD_JOBS)
      return 0
      ;;
    *) return 1 ;;
  esac
